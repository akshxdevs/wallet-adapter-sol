        ...
        <div className="flex justify-between p-8">
            {showSignMessageModel ? (
                ...
                <div className="bg-[#2a2a2a] rounded-xl p-2">
                    <button className="flex justify-center items-center px-3 text-[#9a82e1]" onClick={()=>setShowSignMessageModel(true)}>
            ...
            {showSendTokenModel ? (
                ...
                <div className="bg-[#2a2a2a] rounded-xl p-2">
                    <button className="flex justify-center items-center px-3 text-[#9a82e1]" onClick={()=>setShowSendTokenModel(true)}>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="size-6">
            ...
            {showAirdropModel ? (
                ...
                <div className="bg-[#2a2a2a] rounded-xl p-2">
                    <button className="flex justify-center items-center px-3 text-[#9a82e1]" onClick={()=>setShowAirdropModel(true)}>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="size-6">
